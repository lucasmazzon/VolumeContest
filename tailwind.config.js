...
module.exports = {
  ...
  theme: {
    ...
    colors: {
      ...
      'gradient-3': `linear-gradient(#ffffff, #000000)`,
    ...
    extend: {
      backgroundImage: () => ({
        ...
        'gradient-primary': `linear-gradient(90deg, #b53400, 10%, #ffae00)`,
        'green-menu1': `linear-gradient(360deg, #000000, 30%, #26ff17)`,
        'green-menu2': `linear-gradient(90deg, #000000, 30%, #26ff17 90%)`,
